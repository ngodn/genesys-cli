...
module.exports = function (program) {
  ...
  program
    ...
    .description('Bootstrap a subclass of genesys-pieces with all the configuration you need to get started')
    .option('--pages', 'Configure a corresponding genesys-pieces-pages module')
    .option('--widgets', 'Configure a corresponding genesys-pieces-widgets module')
    .action(function(pieceName, options) {
      ...
      if (options.pages) {
        ...
        util.nlog('create-piece', 'YOUR NEXT STEP: add the ' + pieceName + '-page page type to the "types" array in lib/modules/genesys-pages/index.js.');
      }
