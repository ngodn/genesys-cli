...
var prefix = ' Genesys '.bgWhite.red.bold;
...
util.getAppPath = function(path) {
  ...
  if (fs.existsSync(path + '/app.js')) {
    ...
    if (fs.realpathSync(path).match(rootPath)) {
      ...
      util.error('Unable to locate an app.js in this directory. You need to be in the root directory of a Genesys project to run this command.');
      return null;
    }
